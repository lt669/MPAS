...
void loadTextImages(){
  ...
  image(soloTitle,width*0.25,height*0.80);
  varianceTitle.resize(0,50); 
  image(varianceTitle,width*0.75,height*0.80);

  //Load different images for different difficulties
  if(diffKey ==1){
    easy.resize(0,50); 
    image(easy,width*0.5,height*0.10);
  } else if(diffKey ==2){
    average.resize(0,50); 
    image(average,width*0.5,height*0.10);
  } else if(diffKey ==3){
    hard.resize(0,50); 
    image(hard,width*0.5,height*0.10);
  }
}
